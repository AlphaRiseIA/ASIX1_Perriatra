...
-- -----------------------------------------------------
-- Table `db_perriatra`.`form_ayuda`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_perriatra`.`form_ayuda` (
  ...
  `estado` ENUM('pendiente', 'en revision', 'solucionada') NOT NULL DEFAULT 'pendiente',
