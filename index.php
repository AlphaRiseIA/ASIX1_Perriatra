...
<div class="admin-panel">
    <h1>Panel de Administración Veterinaria</h1><br><br>
    <p class="welcome">Bienvenido, <strong><?= htmlspecialchars($_SESSION['nombre_u'], ENT_QUOTES, 'UTF-8') ?></strong></p>
    ...
    <div class="category-container">
        ...
        <div class="admin-options">
            ...
            <?php if ($isAdmin): ?>
                ...
                <a href="./procesos/vistas/panel.php">Incidencias</a>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="category-container">
        ...
        <div class="admin-options">
            ...
            <a href="./procesos/forms/form_ayuda.php">Incidencia</a>
            <?php if ($isAdmin): ?>
